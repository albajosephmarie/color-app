...
export const colorAppSvgDownloadHtml = (palette, darkModePalette) => {
  const squaresPerLine = 5;
  const squareWidth = 200;
  const squareHeight = 150;
  const margin = 10;
      ...
      svgHeight + svgDarkModeHeight + 30
        ...
        ${palette
          .map(
            (e, index) => `
          <rect x="${
            (index % squaresPerLine) * (squareWidth + margin) + margin
          }" 
                y="${
                  Math.floor(index / squaresPerLine) * (squareHeight + margin) +
                  titleHeight
          ...
          <text x="${
            (index % squaresPerLine) * (squareWidth + margin) + margin + 80
          }" 
                y="${
                  Math.floor(index / squaresPerLine) * (squareHeight + margin) +
                  titleHeight +
          ...
          <text x="${
            (index % squaresPerLine) * (squareWidth + margin) + margin + 25
          }" 
                y="${
                  Math.floor(index / squaresPerLine) * (squareHeight + margin) +
                  titleHeight +
